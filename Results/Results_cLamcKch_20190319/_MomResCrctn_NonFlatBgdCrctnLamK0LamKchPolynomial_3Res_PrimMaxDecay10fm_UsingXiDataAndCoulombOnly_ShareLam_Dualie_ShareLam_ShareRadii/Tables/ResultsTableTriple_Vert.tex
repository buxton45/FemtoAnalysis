...
\begin{table}[htbp]
 ...
 The uncertainties marked as ``stat." are those returned by MINUIT~\cite{JAMES1975343}, and those marked as ``syst." result from the systematic analysis.
 }
...
\begin{table}[htbp]
 ...
 \begin{tabular}{c|c|c|c}
  \clineB{1-3}{3.0}
  \multirow{2}{*}{Centrality} & \multirow{2}{*}{$\lambda_{\mathrm{Fit}}$} & \multicolumn{1}{c}{\multirow{2}{*}{$R_{\mathrm{inv}}$}} & \multicolumn{1}{c}{} \\
   & & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\
  \clineB{1-3}{3.0}  
   \multirow{2}{*}{0--10\%} 
     & \multirow{2}{*}{\ArrLamKchP(1) $\pm$ \ArrLamKchP(2) (stat.) $\pm$ \ArrLamKchP(3) (syst.)}    %Lambda (LamKchP 0010)
     & \multicolumn{1}{c}{\multirow{2}{*}{\ArrLamKchP(4) $\pm$ \ArrLamKchP(5) (stat.) $\pm$ \ArrLamKchP(6) (syst.)}}    %Radius (LamKchP & ALamKchM 0010)
     & \multicolumn{1}{c}{} \\    
    & & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\     
   \cline{1-3}
   ...
   \multirow{2}{*}{10--30\%}
     ...
     & \multicolumn{1}{c}{\multirow{2}{*}{\ArrLamKchP(10) $\pm$ \ArrLamKchP(11) (stat.) $\pm$ \ArrLamKchP(12) (syst.)}}    %Radius (LamKchP & ALamKchM 1030)    
     & \multicolumn{1}{c}{} \\  
    & & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\  
   \cline{1-3}           
   ...
   \multirow{2}{*}{30--50\%}
     ...
     & \multicolumn{1}{c}{\multirow{2}{*}{\ArrLamKchP(16) $\pm$ \ArrLamKchP(17) (stat.) $\pm$ \ArrLamKchP(18) (syst.)}}    %Radius (LamKchP & ALamKchM 3050)   
     & \multicolumn{1}{c}{} \\  
    & & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\  
   %\clineB{1-3}{6.0}
   \cline{1-3}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
   ...
   %\hlineB{6.0}
   \hlineB{3.0}
  \multirow{2}{*}{System} & \multirow{2}{*}{$\Re f_{0}$} & \multirow{2}{*}{$\Im f_{0}$} & \multirow{2}{*}{$d_{0}$} \\
   & & & \\
  \clineB{1-4}{3.0}  
