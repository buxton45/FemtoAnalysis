...
*/
  ...
  //-----------------------------------------------
  TCanvas *aCanRatio1 = new TCanvas("aCanRatio1","aCanRatio1");
  aCanRatio1->cd();

  TH2 *tRatioNoRmVsRmAll = (TH2*)tNoRm->Clone("tRatioNoRmVsRmAll");
  //tRatioNoRmVsRmAll->Divide(tRmAll);
  tRatioNoRmVsRmAll->Add(tRmAll,-1);
  tRatioNoRmVsRmAll->Draw("colz");
