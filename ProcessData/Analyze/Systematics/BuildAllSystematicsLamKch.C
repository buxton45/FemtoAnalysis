...
SystematicsFileInfo GetFileInfo(int aNumber)
{
  SystematicsFileInfo gInfo1;
    ...
    gInfo1.dirNameModifierBase1 = "_ALLV0S_maxDcaV0Daughters_";
    gInfo1.modifierValues1 = vector<double> {0.30,0.40,0.50};
    gInfo1.dirNameModifierBase2 = "";
    gInfo1.modifierValues2 = vector<double> {};
    gInfo1.allCentralities = true;

  SystematicsFileInfo gInfo2;
    gInfo2.resultsDate = "20161025";
    gInfo2.dirNameModifierBase1 = "_ALLV0S_minInvMassReject_";
    gInfo2.modifierValues1 = vector<double> {0.494614, 0.492614, 0.488614, 0.482614};
    gInfo2.dirNameModifierBase2 = "_ALLV0S_maxInvMassReject_";
    gInfo2.modifierValues2 = vector<double> {0.500614, 0.502614, 0.506614, 0.512614};
    gInfo2.allCentralities = false;
  ...
  SystematicsFileInfo gInfo4;
    gInfo4.resultsDate = "20161031";
    gInfo4.dirNameModifierBase1 = "_CLAM_minCosPointingAngle_";
    gInfo4.modifierValues1 = vector<double> {0.9992, 0.9993, 0.9994};
