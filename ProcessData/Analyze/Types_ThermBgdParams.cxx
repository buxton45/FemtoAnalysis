...
const double  cLamKchP_ThermBgdParamValues_0010[7] = {1.00393349, -0.02216495,  0.07043890, -0.14280238,  0.13625773, -0.05967115,  0.00996378};
const double  cLamKchP_ThermBgdParamValues_1030[7] = {1.00411965,  0.01812042, -0.10616621,  0.07624931,  0.01550471, -0.02699188,  0.00629452};
const double  cLamKchP_ThermBgdParamValues_3050[7] = {1.01134138,  0.01212939, -0.16133185,  0.12208876,  0.02738394, -0.04392693,  0.00983262};
...
const double  cLamKchM_ThermBgdParamValues_0010[7] = {1.00448394, -0.02115505,  0.06303914, -0.12947123,  0.12358520, -0.05292098,  0.00845534};
const double  cLamKchM_ThermBgdParamValues_1030[7] = {1.00524824,  0.01078813, -0.09033812,  0.06456855,  0.01476171, -0.02271499,  0.00500957};
const double  cLamKchM_ThermBgdParamValues_3050[7] = {1.00547887,  0.09241651, -0.47484863,  0.67520668, -0.45933475,  0.16347698, -0.02412999};
*/

//----- When all (A)LamKchPM fit together (w. PrimaryOnly tag)
const double  cLamKchM_ThermBgdParamValues_0010[7] = {1.00393349, -0.02216495,  0.07043890, -0.14280238,  0.13625773, -0.05967115,  0.00996378};
const double  cLamKchM_ThermBgdParamValues_1030[7] = {1.00411965,  0.01812042, -0.10616621,  0.07624931,  0.01550471, -0.02699188,  0.00629452};
const double  cLamKchM_ThermBgdParamValues_3050[7] = {1.01134138,  0.01212939, -0.16133185,  0.12208876,  0.02738394, -0.04392693,  0.00983262};
