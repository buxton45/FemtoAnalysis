...
*/
    ...
    tSharedAn->SetSharedParameter(kRef0,-1.5,-5.,5.);
    tSharedAn->SetSharedParameter(kImf0,-1.5,-5.,5.);
    tSharedAn->SetSharedParameter(kd0,0.,-10.,10.);
    tSharedAn->SetSharedParameter(kRef02,0.5,-5.,5.);
    tSharedAn->SetSharedParameter(kImf02,1.5,-5.,5.);
    tSharedAn->SetSharedParameter(kd02,2.,-10.,10.);
/*
    tSharedAn->SetSharedParameter(kLambda,0.5);
    tSharedAn->SetSharedParameter(kRadius,5.);
    tSharedAn->SetSharedParameter(kRef0,0.);
    tSharedAn->SetSharedParameter(kImf0,0.);
    tSharedAn->SetSharedParameter(kd0,0.);
    tSharedAn->SetSharedParameter(kRef02,0.);
    tSharedAn->SetSharedParameter(kImf02,0.);
    tSharedAn->SetSharedParameter(kd02,0.);
*/
  }
...
*/
  ...
  //Best Simplex results
/*
  tSharedAn->SetSharedParameter(kLambda,0.94,0.3,1.);
  tSharedAn->SetSharedParameter(kRadius,4.9,3.,8.);
  tSharedAn->SetSharedParameter(kRef0,2.6,-5.,5.);
  tSharedAn->SetSharedParameter(kImf0,1.7,-5.,5.);
  tSharedAn->SetSharedParameter(kd0,1.5,-9.0,9.0);
  tSharedAn->SetSharedParameter(kRef02,0.1,-5.,5.);
  tSharedAn->SetSharedParameter(kImf02,0.2,-5.,5.);
  tSharedAn->SetSharedParameter(kd02,0.01,-9.0,9.0);
*/
