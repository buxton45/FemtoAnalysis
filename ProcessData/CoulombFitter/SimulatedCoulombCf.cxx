...
//________________________________________________________________________________________________________________
int SimulatedCoulombCf::GetBinNumber(double aBinSize, int aNbins, double aValue)
{
...
//________________________________________________________________________________________________________________
int SimulatedCoulombCf::GetBinNumber(int aNbins, double aMin, double aMax, double aValue)
{
//TODO check the accuracy of this
...
//________________________________________________________________________________________________________________
int SimulatedCoulombCf::GetBinNumber(double aBinWidth, double aMin, double aMax, double aValue)
{
//TODO check the accuracy of this
...
//________________________________________________________________________________________________________________
double SimulatedCoulombCf::LinearInterpolate(TH1* a1dHisto, double aX)
{
...
//________________________________________________________________________________________________________________
double SimulatedCoulombCf::BilinearInterpolate(TH2* a2dHisto, double aX, double aY)
{
  double tF = 0.;
  ...
  {
    cout << "Error in SimulatedCoulombCf::BilinearInterpolate, cannot interpolate outside histogram domain" << endl;
  }
  assert(tXbin>0);
...
//________________________________________________________________________________________________________________
double SimulatedCoulombCf::BilinearInterpolateVector(vector<vector<double> > &a2dVec, double aX, int aNbinsX, double aMinX, double aMaxX, double aY, int aNbinsY, double aMinY, double aMaxY)
{
  ...
  if(tXbin<0 || tYbin<0) 
  {
    cout << "Error in SimulatedCoulombCf::BilinearInterpolateVector, cannot interpolate outside histogram domain" << endl;
  }
  assert(tXbin >= 0);
  assert(tYbin >= 0);
...
//________________________________________________________________________________________________________________
double SimulatedCoulombCf::TrilinearInterpolate(TH3* a3dHisto, double aX, double aY, double aZ)
{
  ...
  {
    cout << "Error in SimulatedCoulombCf::TrilinearInterpolate, cannot interpolate outside histogram domain" << endl;
...
//________________________________________________________________________________________________________________
double SimulatedCoulombCf::QuadrilinearInterpolate(THn* a4dHisto, double aT, double aX, double aY, double aZ)
{
  ...
  {
    cout << "Error in SimulatedCoulombCf::QuadrilinearInterpolate, cannot interpolate outside histogram domain" << endl;
  }
  assert(ubt>0);
  assert(ubx>0);
  assert(uby>0);
