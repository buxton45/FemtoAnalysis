...
//-----------------------------------------------------------------------------
  ...
  const FitInfo tFitInfo1a_LamKchP = FitInfo(TString("FreeRadii_FreeD0_10Res"), 
                                       kLamKchP,
                                       true, true, true, true, 
                                       0.5*(0.96+0.94), 0.5*(0.37+0.36), 0.5*(0.27+0.23),
                                       0.5*(1.18+0.99), 0.5*(0.51+0.42), 0.5*(0.42+0.19),
                                       0.5*(1.01+0.98), 0.5*(0.30+0.29), 0.5*(0.24+0.18),
  ...
  const FitInfo tFitInfo1a_LamKchM = FitInfo(TString("FreeRadii_FreeD0_10Res"), 
                                       kLamKchM,
                                       true, true, true, true, 
                                       0.5*(1.50+1.49), 0.5*(0.72+0.69), 0.5*(0.34+0.36),
                                       0.5*(1.15+1.41), 0.5*(0.51+0.61), 0.5*(0.33+0.35),
                                       0.5*(1.07+0.80), 0.5*(0.73+0.37), 0.5*(0.29+0.26),
