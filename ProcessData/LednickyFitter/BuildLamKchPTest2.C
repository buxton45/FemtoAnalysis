...
*/
  ...
  if(bRunLamKchPwConj)
  {
    ...
    TPaveText* text2 = new TPaveText(0.73,0.80,0.90,0.90,"NDC");
      ...
      if(bSaveFigures) canLamKchPwConj->SaveAs(tSaveFiguresLocation+"LamKchPwConj_Fit.eps");
      ...
      tFitSharedAnalysesLamKchPwConj->DrawFit(0,"LamKchP0010");
      text1->Draw();
      if(bSaveFigures) canLamKchP->SaveAs(tSaveFiguresLocation+"LamKchP_Fit.eps");
      ...
      tFitSharedAnalysesLamKchPwConj->DrawFit(1,"ALamKchM0010");
      text2->Draw();
      if(bSaveFigures) canALamKchM->SaveAs(tSaveFiguresLocation+"ALamKchM_Fit.eps");
    }
  ...
  if(bRunLamKchMwConj)
  {
    ...
    TPaveText* text2 = new TPaveText(0.73,0.80,0.90,0.90,"NDC");
      ...
      if(bSaveFigures) canLamKchMwConj->SaveAs(tSaveFiguresLocation+"LamKchMwConj_Fit.eps");
      ...
      tFitSharedAnalysesLamKchMwConj->DrawFit(0,"LamKchM0010");
      text1->Draw();
      if(bSaveFigures) canLamKchM->SaveAs(tSaveFiguresLocation+"LamKchM_Fit.eps");
      ...
      tFitSharedAnalysesLamKchMwConj->DrawFit(1,"ALamKchP0010");
      text2->Draw();
      if(bSaveFigures) canALamKchP->SaveAs(tSaveFiguresLocation+"ALamKchP_Fit.eps");
    }
