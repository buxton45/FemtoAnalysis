...
//-----------------------------------------------------------------------------
  ...
  TString tHelperBaseLocation = "/home/jesse/Analysis/FemtoAnalysis/ProcessData/LednickyFitter/Systematics/testHelper";
...
//  vector<vector<FitParameter*> > tTest = tFitValWriterwSysErrs->ReadAllParameters(tMasterFileLocation_LamKch, tSystematicsFileLocation_LamKch, tFitInfoTString_LamKch, tAnType);
  ...
  tFitValLatTabHelpWriterwSysErrs->WriteLatexTableHelper(tHelperBaseLocation, tMasterFileLocation, tSystematicsFileLocation, tAnType, kInclude3Residuals);
