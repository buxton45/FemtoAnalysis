...
//----------------------- Set up canvas and axes --------------------------------------------
  ...
  canmtcomb->SetLeftMargin(0.12);
  canmtcomb->SetRightMargin(0.02);
  canmtcomb->SetTopMargin(0.02);
  canmtcomb->SetBottomMargin(0.175);
  ...
  ramka->GetXaxis()->SetLabelSize(0.06);  
  ramka->GetXaxis()->SetLabelOffset(0.01);
  ramka->GetXaxis()->SetTitleSize(0.07);
  ramka->GetXaxis()->SetTitleOffset(1.02);
  ...
  ramka->GetYaxis()->SetLabelSize(0.06);  
  ramka->GetYaxis()->SetLabelOffset(0.01);
  ramka->GetYaxis()->SetTitleSize(0.07);
  ...
  ramka->GetZaxis()->SetLabelSize(0.06);  
  ramka->GetZaxis()->SetLabelOffset(0.01);
  ramka->GetZaxis()->SetTitleSize(0.07);
