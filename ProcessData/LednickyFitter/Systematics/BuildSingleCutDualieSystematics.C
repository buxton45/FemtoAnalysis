...
//-----------------------------------------------------------------------------
  ...
  SystematicsFileInfo tFileInfo = GetFileInfo_LamK(11, tParentResultsDate);
  ...
  DualieFitSystematicAnalysis* tDualieFitSysAn = new DualieFitSystematicAnalysis(tFileLocationBase, tFileLocationBaseMC, tAnType, tDirNameModifierBase1, tModifierValues1, tDirNameModifierBase2, tModifierValues2, tCentralityType, tFitGeneratorType, tShareLambdaParameters, tAllShareSingleLambdaParam, tDualieShareLambda, tDualieShareRadii);
  ...
  tDualieFitSysAn->RunAllFits(bSaveImages, bWriteToFile);
