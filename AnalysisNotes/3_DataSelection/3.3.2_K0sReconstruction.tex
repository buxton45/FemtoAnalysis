...
\begin{figure}[h]
  ...
  \caption[K$^{0}_{S}$ Purity]{Invariant mass (M$_{inv}$) distribution of all K$^{0}_{S}$ candidates immediately before the final invariant mass cut.  This distribution is used to calculate the collection purity, Purity(K$^{0}_{S}$) $\approx$ 98\%.}
  \label{fig:K0Purity}
\end{figure}
