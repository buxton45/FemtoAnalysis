...
\begin{figure}[h!]
  ...
  \subfloat[\Ks]{
    ...
    \includegraphics[width=0.49\textwidth]{3_DataSelection/Figures/V0PurBgdEst_DataVsNumVsDenK0.pdf}}
  %%----start of second subfigure---
  \subfloat[\Lam]{
    \label{fig:V0PurBgdEst:b}
    \includegraphics[width=0.49\textwidth]{3_DataSelection/Figures/V0PurBgdEst_DataVsNumVsDenLam.pdf}}
  %%----overall caption----
