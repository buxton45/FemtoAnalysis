...
\begin{figure}[h!]
  ...
  \subfloat[\LamKchP (left) and \ALamKchM (right).  Fully correct Stavinskiy shown as open symbols.]{
  ...
  \subfloat[\LamKchM (left) and \ALamKchP (right).  Fully correct Stavinskiy shown as open symbols.]{
  ...
  \subfloat[\LamKs (left) and \ALamKs (right).  Fully correct Stavinskiy shown as open symbols.]{
...
\begin{figure}[h!]
  \centering
  %%----start of first subfigure---  
  \subfloat[\LamKchP (left) and \ALamKchM (right).  Incorrect Stavinskiy shown as open symbols.]{
  ...
  %%----start of third subfigure---  
  \subfloat[\LamKchM (left) and \ALamKchP (right).  Incorrect Stavinskiy shown as open symbols.]{
  ...
  %%----start of fifth subfigure---  
  \subfloat[\LamKs (left) and \ALamKs (right).  Incorrect Stavinskiy shown as open symbols.]{
