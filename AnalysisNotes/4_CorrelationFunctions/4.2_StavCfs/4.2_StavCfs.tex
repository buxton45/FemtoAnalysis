...
\begin{figure}[h!]
  ...
  \subfloat[\LamKs (left) and \ALamKs (right).  Fully correct Stavinsky shown as open symbols.]{
...
\begin{figure}[h!]
  ...
  %%----start of fifth subfigure---  
  \subfloat[\LamKs (left) and \ALamKs (right).  Incorrect Stavinsky shown as open symbols.]{
