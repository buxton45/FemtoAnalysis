...
\begin{table}[htbp]
 ...
 \begin{tabular}{|c|c|c|c|c|}
  \multicolumn{2}{c}{} & \multicolumn{3}{c}{\textbf{\large Fit Parameters} (\large \textbf{value $\pm$ statistical error $\pm$ systematic error)}} \\
  \hline
  \textbf{\large Pair Type} & \textbf{\large Centrality} & \textbf{\large R} & \multicolumn{2}{c|}{\textbf{\large Scattering Parameters}} \\
  \cline{1-5}
  \multirow{3}{*}{\large \textbf{$\Lambda$K$^{+}$ \& $\bar{\Lambda}$K$^{-}$}}
  &  \textbf{0-10\%} & \textbf{4.04 $\pm$ 0.38 $\pm$ 0.83} & \hspace{0.5cm} $\mathbf{\Re f_{0}}$ \hspace{0.5cm} & \textbf{-0.69 $\pm$ 0.16 $\pm$ 0.22} \\
  & \textbf{10-30\%} & \textbf{3.92 $\pm$ 0.45 $\pm$ 0.66} & $\mathbf{\Im f_{0}}$ & \textbf{0.39 $\pm$ 0.14 $\pm$ 0.11} \\
  & \textbf{30-50\%} & \textbf{3.72 $\pm$ 0.55 $\pm$ 0.42} & $\mathbf{d_{0}}$ & \textbf{0.64 $\pm$ 0.53 $\pm$ 1.62} \\
  
  \hline
  \hline
  
  \multirow{3}{*}{\large \textbf{$\Lambda$K$^{-}$ \& $\bar{\Lambda}$K$^{+}$}} 
  &  \textbf{0-10\%} & \textbf{4.79 $\pm$ 0.79 $\pm$ 1.38} & $\mathbf{\Re f_{0}}$ & \textbf{0.18 $\pm$ 0.13 $\pm$ 0.10} \\
  & \textbf{10-30\%} & \textbf{4.00 $\pm$ 0.72 $\pm$ 0.98} & $\mathbf{\Im f_{0}}$ & \textbf{0.45 $\pm$ 0.18 $\pm$ 0.18} \\
  & \textbf{30-50\%} & \textbf{2.11 $\pm$ 0.52 $\pm$ 0.46} & $\mathbf{d_{0}}$ & \textbf{-5.29 $\pm$ 2.94 $\pm$ 7.66} \\

   
  \hline
  \hline  
  
  \multirow{3}{*}{\large \textbf{$\Lambda$K$^{0}_{S}$ \& $\bar{\Lambda}$K$^{0}_{S}$}}  
   &  \textbf{0-10\%} & \textbf{3.02 $\pm$ 0.54 $\pm$ 0.33} & $\mathbf{\Re f_{0}}$ & \textbf{-0.16 $\pm$ 0.03 $\pm$ 0.04} \\
   & \textbf{10-30\%} & \textbf{2.27 $\pm$ 0.41 $\pm$ 0.32} & $\mathbf{\Im f_{0}}$ & \textbf{0.18 $\pm$ 0.08 $\pm$ 0.06} \\
   & \textbf{30-50\%} & \textbf{1.67 $\pm$ 0.30 $\pm$ 0.28} & $\mathbf{d_{0}}$ & \textbf{3.57 $\pm$ 0.95 $\pm$ 2.84} \\

  \hline
 \end{tabular}}
%% \caption{Fit Results $\Lambda$($\bar{\Lambda}$)K$^{\pm}$ and $\Lambda$($\bar{\Lambda}$)K$^{0}_{\mathrm{S}}$, with NO residual correlations included ($\lambda$ parameters not shown).  This table is a condensed version of Tables \ref{tab:FitResultsLamK0_NoRes} and \ref{tab:FitResultsLamKch_noRes}} 
 \label{tab:FitResultsLamKCondensed2_NoRes}
\end{table}
...
\begin{table}[htbp]
 ...
 \begin{tabular}{|c|c|c|c|c|c|}
  \multicolumn{6}{c}{\textbf{\Large Fit Parameters} (\Large \textbf{value $\pm$ statistical error $\pm$ systematic error)}} \\
  \hline
  \textbf{\large Pair Type} & \textbf{\large Centrality} & \textbf{\large R} & \large $\mathbf{\Re f_{0}}$ & \large $\mathbf{\Im f_{0}}$ & \large $\mathbf{d_{0}}$ \\
  \cline{1-6}
  \multirow{3}{*}{\large \textbf{$\Lambda$K$^{+}$ \& $\bar{\Lambda}$K$^{-}$}}
  & \textbf{0-10\%} & \textbf{4.04 $\pm$ 0.38 $\pm$ 0.83} 
  & \multirow{3}{*}{\textbf{-0.69 $\pm$ 0.16 $\pm$ 0.22}} 
  & \multirow{3}{*}{\textbf{0.39 $\pm$ 0.14 $\pm$ 0.11}} 
  & \multirow{3}{*}{\textbf{0.64 $\pm$ 0.53 $\pm$ 1.62}} \\
  & \textbf{10-30\%} & \textbf{3.92 $\pm$ 0.45 $\pm$ 0.66} & & & \\
  & \textbf{30-50\%} & \textbf{3.72 $\pm$ 0.55 $\pm$ 0.42} & & & \\
  
  \hline
  \hline
  
  \multirow{3}{*}{\large \textbf{$\Lambda$K$^{-}$ \& $\bar{\Lambda}$K$^{+}$}} 
  & \textbf{0-10\%} & \textbf{4.79 $\pm$ 0.79 $\pm$ 1.38} 
  & \multirow{3}{*}{\textbf{0.18 $\pm$ 0.13 $\pm$ 0.10}} 
  & \multirow{3}{*}{\textbf{0.45 $\pm$ 0.18 $\pm$ 0.18}} 
  & \multirow{3}{*}{\textbf{-5.29 $\pm$ 2.94 $\pm$ 7.66}} \\      
  & \textbf{10-30\%} & \textbf{4.00 $\pm$ 0.72 $\pm$ 0.98} & & & \\
  & \textbf{30-50\%} & \textbf{2.11 $\pm$ 0.52 $\pm$ 0.46} & & & \\
  ...
  \multirow{3}{*}{\large \textbf{$\Lambda$K$^{0}_{S}$ \& $\bar{\Lambda}$K$^{0}_{S}$}}  
  & \textbf{0-10\%} & \textbf{3.02 $\pm$ 0.54 $\pm$ 0.33} 
  & \multirow{3}{*}{\textbf{-0.16 $\pm$ 0.03 $\pm$ 0.04}} 
  & \multirow{3}{*}{\textbf{0.18 $\pm$ 0.08 $\pm$ 0.06}} 
  & \multirow{3}{*}{\textbf{3.57 $\pm$ 0.95 $\pm$ 2.84}} \\     
  & \textbf{10-30\%} & \textbf{2.27 $\pm$ 0.41 $\pm$ 0.32} & & & \\
  & \textbf{30-50\%} & \textbf{1.67 $\pm$ 0.30 $\pm$ 0.28} & & & \\

  \hline
 \end{tabular}}
%% \caption{Fit Results $\Lambda$($\bar{\Lambda}$)K$^{\pm}$ and $\Lambda$($\bar{\Lambda}$)K$^{0}_{\mathrm{S}}$, with NO residual correlations included ($\lambda$ parameters not shown).  This table is a condensed version of Tables \ref{tab:FitResultsLamK0_NoRes} and \ref{tab:FitResultsLamKch_noRes}} 
 \label{tab:FitResultsLamKCondensed3_NoRes}
\end{table}
