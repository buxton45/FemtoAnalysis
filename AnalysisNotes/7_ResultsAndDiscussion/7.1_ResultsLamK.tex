...
\begin{table}[htbp]
 ...
 \begin{tabular}{|c|c|c|c|c|}
  ...
  &  \textbf{0-10\%} & \multicolumn{3}{c|}{\textbf{4.05 $\pm$ 0.38 $\pm$ 0.83}} \\  %Radius
  ...
  & & \large $\mathbf{\mathbb{R}f_{0}}$ & \large $\mathbf{\mathbb{I}f_{0}}$ & \large $\mathbf{d_{0}}$ \\
  \cline{3-5}     
  & & \textbf{0.18 $\pm$ 0.13 $\pm$ 0.10} & \textbf{0.45 $\pm$ 0.18 $\pm$ 0.18} & \textbf{-5.29 $\pm$ 2.90 $\pm$ 7.66} \\
  ...
  \multirow{5}{*}{\large \textbf{$\Lambda$K$^{0}_{S}$ \& $\bar{\Lambda}$K$^{0}_{S}$}}  
   ...
   & \textbf{30-50\%} & \multicolumn{3}{c|}{\textbf{1.67 $\pm$ 0.31 $\pm$ 0.28}} \\  %Radius
   \cline{2-5}   
   & & \large $\mathbf{\mathbb{R}f_{0}}$ & \large $\mathbf{\mathbb{I}f_{0}}$ & \large $\mathbf{d_{0}}$ \\
   \cline{3-5} 
