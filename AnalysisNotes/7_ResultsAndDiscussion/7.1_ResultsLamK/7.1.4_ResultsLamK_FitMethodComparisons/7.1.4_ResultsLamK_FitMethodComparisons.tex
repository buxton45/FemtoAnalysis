...
\begin{figure}[h!]
  ...
  \subfloat[Shared radii]{
    ...
    \includegraphics[width=0.750\linewidth]{7_ResultsAndDiscussion/Figures/New/CompareAllScattParamswSys_CompFreevsFixedLam_Std_StatOnly.pdf}}
  \\  
  %%----start of second subfigure---
  \subfloat[Separate radii]{
    \label{fig:CompareAllScattParams_FreevsFixlam:b}
    \includegraphics[width=0.750\linewidth]{7_ResultsAndDiscussion/Figures/New/CompareAllScattParamswSys_CompFreevsFixedLam_SepR_Std_StatOnly.pdf}}  
  %%----overall caption----
...
\begin{figure}[h!]
  ...
  \subfloat[Shared radii]{
    ...
    \includegraphics[width=0.750\linewidth]{7_ResultsAndDiscussion/Figures/New/CompareAllScattParamswSys_CompSharedvsUniqueLam_Std_StatOnly.pdf}}
  \\  
  %%----start of second subfigure---
  \subfloat[Separate radii]{
    \label{fig:CompareAllScattParams_SharedvsUniquelam:b}
    \includegraphics[width=0.750\linewidth]{7_ResultsAndDiscussion/Figures/New/CompareAllScattParamswSys_CompSharedvsUniqueLam_SepR_Std_StatOnly.pdf}}  
  %%----overall caption----
...
\begin{figure}[h!]
  ...
  %%----start of first subfigure---  
  \subfloat[Shared radii]{
    \label{fig:CompareAllScattParams_SharevsSepR:a}
    \includegraphics[width=0.750\linewidth]{7_ResultsAndDiscussion/Figures/New/CompareAllScattParamswSys_CompSharedvsSepRLam_Std_StatOnly.pdf}}
  \\  
  %%----start of second subfigure---
  \subfloat[Separate radii]{
    \label{fig:CompareAllScattParams_SharevsSepR:b}
    \includegraphics[width=0.750\linewidth]{7_ResultsAndDiscussion/Figures/New/CompareAllScattParamswSys_CompSharedvsSepR_ShareLamConj_Std_StatOnly.pdf}}  
  %%----overall caption----
  \caption[Compare Fit Parameters: Shared vs. Separate Radii]{Compare Fit Parameters: Shared vs. Separate Radii:  Results shown for the case of radii being shared between \LamKchP and \LamKchM (circles) vs not shared (squares).  In (a), when the radii are not shared between \LamKchP and \LamKchM, neither are the $\lambda$ parameters.  In (b), the $\lambda$ parameters are always shared between \LamKchP and \LamKchM}
