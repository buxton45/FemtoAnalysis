...
//_________________________________________________________________________________________________________________
TObjArray* BuildPurityBgFit(char* name, TH1F* PurityHisto, double BgFitLow[2], double BgFitHigh[2], double ROI[2])
{
  char buffer[50];
...
//_________________________________________________________________________________________________________________
void PurityDrawAll(TH1F* PurityHisto, TObjArray* FitList, bool ZoomBg)
{
  TF1* fitBgd = (TF1*)FitList->At(0);
    fitBgd->SetLineColor(4);
  //-----
  TVectorD* vInfo = (TVectorD*)FitList->At(1);
  //-----
  TVectorD* vROI = (TVectorD*)FitList->At(2);
  //-----
  TVectorD* vBgFitLow = (TVectorD*)FitList->At(3);
  //-----
  TVectorD* vBgFitHigh = (TVectorD*)FitList->At(4);
  //--------------------------------------------------------------------------------------------
...
void calcPur4()
{
  ...
  TObjArray* LamList = BuildPurityBgFit("LambdaPurity",LambdaPurity,LamBgFitLow,LamBgFitHigh,LamROI);
  ...
  TObjArray* K0Short1List = BuildPurityBgFit("K0Short1Purity",K0Short1Purity,K0Short1BgFitLow,K0Short1BgFitHigh,K0Short1ROI);
  ...
  TObjArray* ALamList = BuildPurityBgFit("AntiLambdaPurity",AntiLambdaPurity,ALamBgFitLow,ALamBgFitHigh,ALamROI);
  ...
  TObjArray* K0Short2List = BuildPurityBgFit("K0Short2Purity",K0Short2Purity,K0Short2BgFitLow,K0Short2BgFitHigh,K0Short2ROI);
...
//-----------------------------------------------------------------------------
  ...
  //-----
  c1->cd(1);
  PurityDrawAll(LambdaPurity,LamList,false);
  c1->cd(2);
  PurityDrawAll(LambdaPurity,LamList,true);
  //-----
  c1->cd(3);
  PurityDrawAll(K0Short1Purity,K0Short1List,false);
  c1->cd(4);
  PurityDrawAll(K0Short1Purity,K0Short1List,true);
  //-----
  c1->cd(5);
  PurityDrawAll(AntiLambdaPurity,ALamList,false);
  c1->cd(6);
  PurityDrawAll(AntiLambdaPurity,ALamList,true);
  //-----
  c1->cd(7);
  PurityDrawAll(K0Short2Purity,K0Short2List,false);
  c1->cd(8);
  PurityDrawAll(K0Short2Purity,K0Short2List,true);
