...
bool rungrid = true;
TString aConfigMacro = "ConfigFemtoAnalysis_K0Lam.C";
TString AdditionalLibs = "libPWGCFfemtoscopy.so libPWGCFfemtoscopyUser.so myAliFemtoV0TrackCut.h myAliFemtoV0TrackCut.cxx myAliFemtoKStarCorrFctn.h myAliFemtoKStarCorrFctn.cxx KStarCF.h KStarCF.cxx myAliFemtoVertexMultAnalysis.h myAliFemtoVertexMultAnalysis.cxx ConfigFemtoAnalysis_K0Lam.C";
TString aGridWorkingDir = "ALamK0_Bp1";
TString aGridOutputDir = "output_data";
TString outputname = "Resultsgrid_ALamK0_Bp1.root";
...
void Run1()
{
    ...
    //
    gROOT->LoadMacro("myAliFemtoV0TrackCut.cxx+g");  //I put this line in ConfigFemtoAnalysis_K0Lam.C to try to run on grid
