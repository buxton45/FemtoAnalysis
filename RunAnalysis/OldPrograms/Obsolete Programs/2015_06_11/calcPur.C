...
TList* BuildPurityBgFit(char* name, TH1F* PurityHisto, double BgFitLow[2], double BgFitHigh[2], double ROI[2])
{
  ...
  TVectorD *tempInfo = new TVectorD(4);
  tempInfo(0) = bgd;
  tempInfo(1) = sigpbgd;
  tempInfo(2) = sig;
  tempInfo(3) = pur;
...
void PurityDrawAll(TH1F* PurityHisto, TList* FitList)
{
  ...
  //-----
  TVectorD* info = (TVectorD*)iter.Next();
  //-----
...
//_________________________________________________________________________________________________________________
void PurityDrawBg(TH1F* PurityHisto, TList* FitList, double BgFitLow[2], double BgFitHigh[2])
{
...
//-----------------------------------------------------------------------------
  ...
  c1->cd(4);
  PurityDrawBg(K0Short1Purity,K0Short1List,K0Short1BgFitLow,K0Short1BgFitHigh);
  //-----
  c1->cd(5);
  ...
  c1->cd(8);
  PurityDrawBg(K0Short2Purity,K0Short2List,K0Short2BgFitLow,K0Short2BgFitHigh);
