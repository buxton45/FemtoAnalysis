...
bool rungrid = true;
TString aConfigMacro = "ConfigFemtoAnalysis_Kch.C";
TString AdditionalLibs = "libPWGCFfemtoscopy.so libPWGCFfemtoscopyUser.so myAliFemtoV0TrackCut.h myAliFemtoV0TrackCut.cxx myAliFemtoKStarCorrFctn.h myAliFemtoKStarCorrFctn.cxx KStarCF.h KStarCF.cxx myAnalysisConstructor.h myAnalysisConstructor.cxx ConfigFemtoAnalysis_Kch.C";
TString aGridWorkingDir = "Resultsgrid_cLamcKch_Bp1";
TString aGridOutputDir = "output_data";
TString outputname = "Resultsgrid_cLamcKch_Bp1.root";
...
//        alienHandler->SetRunMode("full");
        ...
        alienHandler->SetAnalysisSource("myAliFemtoV0TrackCut.cxx myAliFemtoKStarCorrFctn.cxx KStarCF.cxx myAnalysisConstructor.cxx"); // Add any cxx files which need compiled here (.cxx files)
