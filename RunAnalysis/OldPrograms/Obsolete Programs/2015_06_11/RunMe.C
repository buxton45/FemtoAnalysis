...
TString AdditionalLibs = "libPWGCFfemtoscopy.so libPWGCFfemtoscopyUser.so myAliFemtoV0TrackCut.h myAliFemtoV0TrackCut.cxx myAliFemtoKStarCorrFctn.h myAliFemtoKStarCorrFctn.cxx KStarCF.h KStarCF.cxx myAnalysisConstructor.h myAnalysisConstructor.cxx ConfigFemtoAnalysis.C";
TString aGridWorkingDir = "TEST";
