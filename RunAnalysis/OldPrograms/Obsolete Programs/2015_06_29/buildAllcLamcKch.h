...
inline void buildAllcLamcKch::SetDebug(bool aDebug) {fDebug = aDebug;}
inline void buildAllcLamcKch::SetOutputPurityFitInfo(bool aOutputPurityFitInfo) {fOutputPurityFitInfo = aOutputPurityFitInfo;}
...
//KStar CF------------------
inline void buildAllcLamcKch::SetMinNormCF(double aMinNormCF) {fMinNormCF = aMinNormCF;}
inline void buildAllcLamcKch::SetMaxNormCF(double aMaxNormCF) {fMaxNormCF = aMaxNormCF;}
inline double buildAllcLamcKch::GetMinNormCF() {return fMinNormCF;}
inline double buildAllcLamcKch::GetMaxNormCF() {return fMaxNormCF;}

inline void buildAllcLamcKch::SetMinNormBinCF(int aMinNormBinCF) {fMinNormBinCF = aMinNormBinCF;}
inline void buildAllcLamcKch::SetMaxNormBinCF(int aMaxNormBinCF) {fMaxNormBinCF = aMaxNormBinCF;}
inline int buildAllcLamcKch::GetMinNormBinCF() {return fMinNormBinCF;}
inline int buildAllcLamcKch::GetMaxNormBinCF() {return fMaxNormBinCF;}
...
//Average Separation CF------------------
inline void buildAllcLamcKch::SetMinNormAvgSepCF(double aMinNormAvgSepCF) {fMinNormAvgSepCF = aMinNormAvgSepCF;}
inline void buildAllcLamcKch::SetMaxNormAvgSepCF(double aMaxNormAvgSepCF) {fMaxNormAvgSepCF = aMaxNormAvgSepCF;}
inline double buildAllcLamcKch::GetMinNormAvgSepCF() {return fMinNormAvgSepCF;}
inline double buildAllcLamcKch::GetMaxNormAvgSepCF() {return fMaxNormAvgSepCF;}

inline void buildAllcLamcKch::SetMinNormBinAvgSepCF(int aMinNormBinAvgSepCF) {fMinNormBinAvgSepCF = aMinNormBinAvgSepCF;}
inline void buildAllcLamcKch::SetMaxNormBinAvgSepCF(int aMaxNormBinAvgSepCF) {fMaxNormBinAvgSepCF = aMaxNormBinAvgSepCF;}
inline int buildAllcLamcKch::GetMinNormBinAvgSepCF() {return fMinNormBinAvgSepCF;}
inline int buildAllcLamcKch::GetMaxNormBinAvgSepCF() {return fMaxNormBinAvgSepCF;}
