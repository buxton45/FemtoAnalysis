...
inline void buildAllcLamK0::SetDebug(bool aDebug) {fDebug = aDebug;}
inline void buildAllcLamK0::SetOutputPurityFitInfo(bool aOutputPurityFitInfo) {fOutputPurityFitInfo = aOutputPurityFitInfo;}
...
//KStar CF------------------
inline void buildAllcLamK0::SetMinNormCF(double aMinNormCF) {fMinNormCF = aMinNormCF;}
inline void buildAllcLamK0::SetMaxNormCF(double aMaxNormCF) {fMaxNormCF = aMaxNormCF;}
inline double buildAllcLamK0::GetMinNormCF() {return fMinNormCF;}
inline double buildAllcLamK0::GetMaxNormCF() {return fMaxNormCF;}
...
//Average Separation CF------------------
inline void buildAllcLamK0::SetMinNormAvgSepCF(double aMinNormAvgSepCF) {fMinNormAvgSepCF = aMinNormAvgSepCF;}
inline void buildAllcLamK0::SetMaxNormAvgSepCF(double aMaxNormAvgSepCF) {fMaxNormAvgSepCF = aMaxNormAvgSepCF;}
inline double buildAllcLamK0::GetMinNormAvgSepCF() {return fMinNormAvgSepCF;}
inline double buildAllcLamK0::GetMaxNormAvgSepCF() {return fMaxNormAvgSepCF;}
