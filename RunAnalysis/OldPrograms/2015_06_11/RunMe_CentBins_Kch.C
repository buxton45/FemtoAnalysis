...
TString AdditionalLibs = "libPWGCFfemtoscopy.so libPWGCFfemtoscopyUser.so myAliFemtoV0TrackCut.h myAliFemtoV0TrackCut.cxx myAliFemtoKStarCorrFctn.h myAliFemtoKStarCorrFctn.cxx myAliFemtoAvgSepCorrFctn.h myAliFemtoAvgSepCorrFctn.cxx KStarCF.h KStarCF.cxx myAnalysisConstructor.h myAnalysisConstructor.cxx ConfigFemtoAnalysis_CentBins_Kch.C myAliFemtoSepCorrFctns.h myAliFemtoSepCorrFctns.cxx";
TString aGridWorkingDir = "Resultsgrid_cLamcKch_CentBins_Bm3NEW2";
TString aGridOutputDir = "output_data";
TString outputname = "Resultsgrid_cLamcKch_CentBins_Bm3NEW2.root";



void RunMe_CentBins_Kch()
{
    cout << "[RunMe] Begin\n";
