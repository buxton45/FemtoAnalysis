...
//______________________________
bool myAliFemtoSepCorrFctns::IsPionNSigma(float mom, float nsigmaTPCPi, float nsigmaTOFPi)
{
  if(mom<0.8)
    {
...
//______________________________
bool myAliFemtoSepCorrFctns::IsProtonNSigma(float mom, float nsigmaTPCP, float nsigmaTOFP)
{
  if(mom<0.8)
    {
...
//______________________________
bool myAliFemtoSepCorrFctns::IsK0Short(AliFemtoV0* aV0)
{
