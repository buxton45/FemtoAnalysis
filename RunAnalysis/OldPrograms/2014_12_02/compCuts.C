...
void compCuts()
{
  ...
  K0Pass_LamMass_1->GetXaxis()->SetRange(FirstNonZero,LastNonZero);
  ...
  TH1F* K0Pass_LamMass_3 = GetHisto("Resultsgrid_cLamK0_Bp1.root","femtolist","K0Lam","LambdaMass_K01_Pass");
  ...
  TH1F* K0Pass_LamMass_5 = GetHisto("Resultsgrid_cLamK0_ss_NEW2c.root","femtolist","K0Lam","LambdaMass_K01_Pass");
  DrawNorm(K0Pass_LamMass_5,5);

  TH1F* K0Pass_LamMass_6 = GetHisto("Resultsgrid_cLamK0_Bp1_NEW.root","femtolist","K0Lam","LambdaMass_K01_Pass");
  DrawNorm(K0Pass_LamMass_6,6);

  leg1 = new TLegend(0.60,0.40,0.89,0.70);
  leg1->SetFillColor(0);
  ...
  leg1->AddEntry(K0Pass_LamMass_5, "Complex MisID & TPC/TOF #pi", "lp");
  leg1->AddEntry(K0Pass_LamMass_6, "Complex MisID & TPC only #pi", "lp");
  leg1->Draw();
