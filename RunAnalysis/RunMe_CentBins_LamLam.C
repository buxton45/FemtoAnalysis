...
//        alienHandler->SetROOTVersion("v5-34-30-alice-8");  //apparently this is no longer needed
        ...
        alienHandler->SetAnalysisSource("myAliFemtoV0TrackCut.cxx myAliFemtoESDTrackCut.cxx myAliFemtoKStarCorrFctn.cxx myAliFemtoAvgSepCorrFctn.cxx myAliFemtoSepCorrFctns.cxx myAliFemtoAvgSepCorrFctnCowboysAndSailors.cxx myAliFemtoKStarCorrFctn2D.cxx myAliFemtoKStarCorrFctnMC.cxx myAnalysisConstructor.cxx"); // Add any cxx files which need compiled here (.cxx files)
