...
//        alienHandler->SetROOTVersion("v5-34-30-alice-8");  //apparently this is no longer needed
  ...
  else
  {
    ...
    if(RunMC)
    {
      ...
      input_files->Add("/alice/sim/2012/LHC12a17a_fix/169144/AOD149/0001/AliAOD.root");
      input_files->Add("/alice/sim/2012/LHC12a17a_fix/169144/AOD149/0002/AliAOD.root");
    }
