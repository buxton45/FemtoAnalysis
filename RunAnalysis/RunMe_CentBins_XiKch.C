...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//Smaller run subsets needed when generating TNtuple *fPairKStar
  int runs_BpA[] = {170593, 170572, 170388, 170387, 170315, 170313, 170312, 170311, 170309, 0};
  int runs_BpB[] = {170308, 170306, 170270, 170269, 170268, 170230, 170228, 170207, 0};
  int runs_BpC[] = {170204, 170203, 170193, 170163, 170159, 170155, 170091, 170089, 0};
  int runs_BpD[] = {170088, 170085, 170084, 170083, 170081, 170040, 170027, 169965, 0};
  int runs_BpE[] = {169923, 169859, 169858, 169855, 169846, 169838, 169837, 169835, 0};

  int runs_BmA[] = {169591, 169590, 169588, 169587, 169586, 169557, 169555, 169554, 169553, 0};
  int runs_BmB[] = {169550, 169515, 169512, 169506, 169504, 169498, 169475, 169420, 169419, 0};
  int runs_BmC[] = {169418, 169417, 169415, 169411, 169238, 169167, 169160, 169156, 169148, 0};
  int runs_BmD[] = {169145, 169144, 169138, 169099, 169094, 169091, 169045, 169044, 0};
  int runs_BmE[] = {169040, 169035, 168992, 168988, 168826, 168777, 168514, 168512, 0};
  int runs_BmF[] = {168511, 168467, 168464, 168460, 168458, 168362, 168361, 168342, 0};
  int runs_BmG[] = {168341, 168325, 168322, 168311, 168310, 168115, 168108, 168107, 0};
  int runs_BmH[] = {168105, 168076, 168069, 167988, 167987, 167985, 167920, 167915, 0};


//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//Even smaller run subsets needed when generating TNtuple *fPairKStar
  int runs_BpI[] = {170593, 170572, 170388, 170387, 170315, 0};
  int runs_BpII[] = {170313, 170312, 170311, 170309, 0};
  int runs_BpIII[] = {170308, 170306, 170270, 170269, 0};
  int runs_BpIV[] = {170268, 170230, 170228, 170207, 0};
  int runs_BpV[] = {170204, 170203, 170193, 170163, 0};
  int runs_BpVI[] = {170159, 170155, 170091, 170089, 0};
  int runs_BpVII[] = {170088, 170085, 170084, 170083, 0};
  int runs_BpVIII[] = {170081, 170040, 170027, 169965, 0};
  int runs_BpIX[] = {169923, 169859, 169858, 169855, 0};
  int runs_BpX[] = {169846, 169838, 169837, 169835, 0};

  int runs_BmI[] = {169591, 169590, 169588, 169587, 0};
  int runs_BmII[] = {169586, 169557, 169555, 169554, 0};
  int runs_BmIII[] = {169553, 169550, 169515, 169512, 0};
  int runs_BmIV[] = {169506, 169504, 169498, 169475, 0};
  int runs_BmV[] = {169420, 169419, 169418, 169417, 0};
  int runs_BmVI[] = {169415, 169411, 169238, 169167, 0};
  int runs_BmVII[] = {169160, 169156, 169148, 169145, 0};
  int runs_BmVIII[] = {169144, 169138, 169099, 169094, 0};
  int runs_BmIX[] = {169091, 169045, 169044, 169040, 0};
  int runs_BmX[] = {169035, 168992, 168988, 168826, 0};
  int runs_BmXI[] = {168777, 168514, 168512, 168511, 0};
  int runs_BmXII[] = {168467, 168464, 168460, 168458, 0};
  int runs_BmXIII[] = {168362, 168361, 168342, 168341, 0};
  int runs_BmXIV[] = {168325, 168322, 168311, 168310, 0};
  int runs_BmXV[] = {168115, 168108, 168107, 168105, 0};
  int runs_BmXVI[] = {168076, 168069, 167988, 167987, 0};
  int runs_BmXVII[] = {167985, 167920, 167915, 0};
...
//        alienHandler->SetROOTVersion("v5-34-30-alice-8");  //apparently this is no longer needed
	...
	for (i = 0; use_runs[i] != 0; i++) {
        ...
        alienHandler->SetMaxMergeFiles(15);  //TODO this is standard
        alienHandler->SetMaxMergeStages(5);
//        alienHandler->SetMaxMergeFiles(5);  //TODO trying this with NTuple file
//        alienHandler->SetMaxMergeStages(15);
