...
// include path
   ...
   gSystem->AddIncludePath("-I$ALICE_PHYSICS/include -I$ALICE_ROOT/include -I$ALICE_PHYSICS/../src/PWGCF/FEMTOSCOPY/AliFemto/ -I$ALICE_PHYSICS/../src/PWGCF/FEMTOSCOPY/AliFemtoUser/ ");
...
// analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L myAliFemtoV0TrackCut.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoESDTrackCut.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoKStarCorrFctn.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoAvgSepCorrFctn.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoSepCorrFctns.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoAvgSepCorrFctnCowboysAndSailors.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoKStarCorrFctn2D.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoKStarCorrFctnMC.cxx+g");
   gROOT->ProcessLine(".L AliFemtoModelWeightGeneratorBasicLednicky.cxx+g");
   gROOT->ProcessLine(".L myAliFemtoModelCorrFctnKStar.cxx+g");
