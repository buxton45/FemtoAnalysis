%%%%%% This document is based off of, and contains pieces of, both apssamp.tex
%%%%%% and apstemplate.tex
...
\title{$\Lambda$K femtoscopy in Pb-Pb collisions at $\sqrt{s_{\mathrm{NN}}} = $ 2.76 TeV with the LHC ALICE experiment}
...
\thanks{See Appendix for the list of collaboration members}
...
\begin{figure}[b]
\includegraphics{/home/jesse/Analysis/FemtoAnalysis/LamKPublication/Figures/LamPurity_LamK0.pdf}% Here is how to import EPS art
...
\begin{figure*}
\includegraphics{/home/jesse/Analysis/FemtoAnalysis/LamKPublication/Figures/K0Purity_LamK0.pdf}% Here is how to import EPS art
...
\bibliography{LamK_bibfile}% Produces the bibliography via BibTeX.
