...
\begin{figure}[htp]
  ...
  \subfigure{
    \label{fig:Purity:a}
    \includegraphics[width=0.49\linewidth]{./Figures/1a_LamPurity_wPrintPurity_LamK0.pdf}}
  %%----start of second subfigure---  
  \subfigure{
    \label{fig:Purity:b}
    \includegraphics[width=0.49\linewidth]{./Figures/1b_K0Purity_wPrintPurity_LamK0.pdf}}
  %%----overall caption----
  \caption{
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{./Figures/2_BgdwFitOnly_RandomEPs_NumWeight1_Full_AllAnwConj_1030_3050_CustomRebin.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{./Figures/3_canKStarCfwFits_CombineConj_AllAn_LabelLines_wErrBands.pdf}
...
\begin{figure}[htp]
  ...
  \subfigure{
    ...
    \includegraphics[width=0.49\linewidth]{./Figures/4a_FinalResults_Comp3An_ImF0vsReF0.pdf}}
  %%----start of second subfigure---  
  \subfigure{
    \label{fig:ScattParams_3Res:b}
    \includegraphics[width=0.49\linewidth]{./Figures/4b_FinalResults_Comp3An_LamvsR.pdf}}
  %%----overall caption----
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.60\textwidth]{./Figures/5_mTscaling_MinvCalcv3_OthersTransparent_3Res_NoResStamp.pdf}
...
\begin{figure}[htp]
  ...
  \subfigure{
    ...
    \includegraphics[width=0.49\linewidth]{./Figures/6a_CanCfYlmC00_LamKchPALamKchM_0010_wSysErr.pdf}}
  %%----start of second subfigure---  
  \subfigure{
    \label{fig:LamKchP_ReC00C11_0010:b}
    \includegraphics[width=0.49\linewidth]{./Figures/6b_CanCfYlmReC11_LamKchPALamKchM_0010_wSysErr.pdf}}
  %%----overall caption----
...
\subfile{./ResultsTable/ResultsTableTriple_Vert.tex}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.50\textwidth]{./Figures/7_canKStarCfsLamKchPCombConj_20190319vs20190319StavCf_CustomRebin.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{./Figures/8_CanCfwSourceAndDeltaTwC11wData_Full_LamKchP_3dHistPairSource3d_oslLamKchP_FromFileCorrelationFunctions_BuildCfYlm.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{./Figures/9_CanPartCompMus_Full_LamKchP_3dHistPairSource3d_oslLamKchP.pdf}
...
\begin{figure}[htp]
  ...
  \subfigure{
    ...
    \includegraphics[width=0.49\linewidth]{./Figures/10a_CanCompFourThermCfYlmC00_Full_RandomEPs_LamKchPALamKchM.pdf}}
  %%----start of second subfigure---  
  \subfigure{
    \label{fig:LamKchP_ThermSources_VaryMuOut_SH:b}
    \includegraphics[width=0.49\linewidth]{./Figures/10b_CanCompFourThermCfYlmReC11_Full_RandomEPs_LamKchPALamKchM.pdf}}
  %%----overall caption----
