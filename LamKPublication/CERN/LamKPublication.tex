...
{\color{blue}{Add a reference to theoretical papers. Introduction devoted to kaon-lambda correlations is still too poor.  There is no physics discussion about the difference in the three systems.  Even in abstract, it is written more about that.}}
...
{\color{blue}{The obtained values of the scattering length and effective radii should be mentioned in the text of Summary}}
