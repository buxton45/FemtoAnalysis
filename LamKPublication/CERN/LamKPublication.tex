...
More specifically, the non-femtoscopic backgrounds were modeled by 6$^{\mathrm{th}}$-order polynomial fits to THERMINATOR 2 simulation; one polynomial for each centrality class and \LamK charge combination.
