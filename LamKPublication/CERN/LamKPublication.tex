...
However, in practice some of the selected particles originate as products from other decaying particles, and some of the final pairs contain a misidentified member.
