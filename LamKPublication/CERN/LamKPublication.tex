...
%  \renewcommand{\arraystretch}{1.5}
  \begin{tabular}{lc|c|l}
   ...
   \multicolumn{3}{l|}{$|\eta|$} & $< 0.8$ \\
   \hline
   \multicolumn{3}{l|}{$|m_{\mathrm{inv}} - m_{\mathrm{PDG}}|$} & $< 17$ MeV/$c^{2}$ \\
   \hline
   \multicolumn{3}{l|}{DCA to primary vertex} & $<$ 0.3 cm \\
   \hline
   \multicolumn{3}{l|}{Cosine of pointing angle} & $>$ 0.9993 \\
...
\begin{figure}[h]
  ...
  {
  THERMINATOR 2 simulation (green) together with experimental data (red, blue, or black).  
  Results are shown for \LamKchP (left), \LamKchM (middle), and \LamKs (right).
  A 6$^{th}$-order polynomial fit to the simulation is shown as a solid green line.  
