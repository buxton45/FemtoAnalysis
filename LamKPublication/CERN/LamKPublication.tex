...
This procedure was applied for four particle species hypotheses--- electron, pion, kaon, and proton--- and for each hypothesis a different $N_{\sigma}$ value was obtained per detector.
...
For this analysis, each event is mixed with five others for the reference distribution construction.
