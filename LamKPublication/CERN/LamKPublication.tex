...
A significant non-femtoscopic, non-flat, background is observed in all of the studied \LamK correlations.  
...
\begin{table}[htbp]
 \centering 
  ...
  \begin{tabular}{|l|r|}
   ...
   \hline
   DCA to PV of $\mathrm{p}\,(\bar{\mathrm{p}})$ Daughter of \LamALam & $>$ [0.05, 0.1, 0.2] cm \\
   \hline
