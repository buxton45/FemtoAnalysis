...
%DIF ADD LamKPublication_v9.tex   Mon Apr 13 19:01:01 2020
...
The \LamK analysis presented \DIFdelbegin \DIFdel{offers low energy }\DIFdelend \DIFaddbegin \DIFadd{here offers the possibility to access }\DIFaddend QCD measurements, which fall into the non-perturbative regime of QCD.
\DIFdelbegin \DIFdel{Therefore, the }%DIFDELCMD < \LamK %%%
\DIFdel{analysis not only gives insight into the strong interaction, it will also help guide future QCD calculations.
This study is particularly interesting, as }\DIFdelend \DIFaddbegin \DIFadd{Furthermore, }\DIFaddend the \LamK scattering parameters were not previously \DIFdelbegin \DIFdel{not }\DIFdelend known, and theoretical predictions are limited.
...
\DIFaddbegin \DIFadd{Femtoscopy studies of K$^{-}$p and K$^{+}$p correlations carried out by ALICE allowed to constrain both interactions more precisely~\mbox{%DIFAUXCMD
\cite{PhysRevLett.124.092301}
}%DIFAUXCMD
}\DIFaddend 
...
The reference distribution is used to \DIFdelbegin \DIFdel{divide out }\DIFdelend \DIFaddbegin \DIFadd{correct for }\DIFaddend the phase-space effects, leaving only the \DIFdelbegin \DIFdel{femtoscopic }\DIFdelend \DIFaddbegin \DIFadd{physical }\DIFaddend effects in the correlation function. 
...
%DIFDELCMD < %%%
\DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{Clearly, the }\DIFaddend THERMINATOR 2 simulation \DIFdelbegin \DIFdel{offers }\DIFdelend \DIFaddbegin \DIFadd{provides }\DIFaddend a good description of the non-femtoscopic backgrounds in the \LamK systems, and can be used in a quantitative fashion to help fit the data.
...
Past studies of kaon-proton scattering found the K$^{-}$\DIFdelbegin \DIFdel{--p }\DIFdelend \DIFaddbegin \DIFadd{p }\DIFaddend interaction to be attractive, and that of the K$^{+}$\DIFdelbegin \DIFdel{--p }\DIFdelend \DIFaddbegin \DIFadd{p }\DIFaddend to be repulsive~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Humphrey:1962zz, Hadjimichef:2002xe, Ikeda:2012au}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Humphrey:1962zz, Hadjimichef:2002xe, Ikeda:2012au, PhysRevLett.124.092301}}%DIFAUXCMD
}\DIFaddend .
